    ...
    <Reveal id="home" className="pt-12 pb-20">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-7">
          <p className="text-slate-300">Hello, I'm</p>
          ...
          <p className="mt-3 text-xl text-slate-300 font-medium">Full Stack Web Developer</p>
          <p className="mt-6 text-slate-300 max-w-xl">I build modern, responsive and high-performance web applications that solve real world problems. Passionate about technology, clean code and creating great user experiences.</p>

          <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
            <Button className="w-full sm:w-auto">Hire Me</Button>
            <Button variant="outline" className="w-full sm:w-auto">View My Work</Button>
          </div>
        ...
        <div className="md:col-span-5 flex justify-center md:justify-end relative">
          <div className="w-72 h-72 rounded-2xl glow-blob blob-animate flex items-center justify-center shadow-soft-lg" aria-hidden>
            <img src={ProfileSVG} alt="profile placeholder" className="w-64 h-64" />
          </div>
        </div>
      </div>
    </Reveal>
